<%-- 
    ...
    Created on : Apr 25, 2018, 11:16:37 AM
    Author     : user
--%>
...
<head>
<title>performanceEvaluation: HR_header</title>
<meta charset="utf-8">
  ...
  <div class="row">
    <div class="columns large-12">
      <div class="row header-inner">
          <div class="columns large-4 small-12" style="margin-top: 50pt"> 
...
<!--            <a href="index.html"><img src="images/logo.png" alt="" class="logo"></a> -->
            ...
            <span style="font-size: x-large; color: white">Performance Evaluation</span>
        </div>
        <div class="columns large-8">
          <nav>
            <section>
              <ul class="sf-menu large-12">
                  <li class="active"><a href="../HR/DesignationDetails.jsp">Add Designation</a></li>
                  <li><a href="../HR/Technology.jsp">Add technology</a></li>
                
                <li class="has-dropdown"><a href="#">Employee</a>
                  <ul class="dropdown">
                      <li class="has-dropdown"><a href="../HR/EmployeeRegistration.jsp">Registration</a>
<!--                      <ul class="dropdown">
                        <li><a href="#">Dropdown Level 2a</a></li>
                        <li><a href="#">Dropdown Level 2b</a></li>
                      </ul>-->
                    </li>
                    <li><a href="../HR/feedback.jsp">Feedback</a></li>
                ...
                <li class="has-dropdown"><a href="#">Work</a>
                  <ul class="dropdown">
                      <li class="has-dropdown"><a href="../HR/WorkApproval.jsp">Work Approval</a>
<!--                      <ul class="dropdown">
                        <li><a href="#">Dropdown Level 2a</a></li>
                        <li><a href="#">Dropdown Level 2b</a></li>
                      </ul>-->
                    </li>
                    <li><a href="../HR/WorkAssign.jsp">Work Assign</a></li>
                    <li><a href="../HR/WorkModule.jsp">Work Module</a></li>
                    <li><a href="../HR/WorkType.jsp">Work Type</a></li>
